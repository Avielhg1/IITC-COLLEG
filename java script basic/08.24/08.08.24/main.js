...
// 'for' Loop Exercises
// 1.	Write a loop that counts from 10 to 1 (backwards). Hint: Start your counter at 10 and decrement it in each iteration. Learn more about for loops
// 2.	Create a loop that prints only even numbers from 2 to 20. Hint: Start at 2 and increment by 2 in each iteration. Learn more about for loops
// 3.	Make a loop that adds up all numbers from 1 to 10 and prints the sum. Hint: Use a variable to keep track of the sum and add each number in the loop. Learn more about for loops
// 4.	Write a loop that prints the 5 times table (5, 10, 15, ..., 50). Hint: Multiply each number in the loop by 5. Learn more about for loops
